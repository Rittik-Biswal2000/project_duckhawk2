...
class _cart2State extends State<cart2> {
  ...
  cod(BuildContext context, String n, String c, String p, String pr, String q,
      String i, String sel) {
              ...
              MaterialButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => new orderconfirm()));
                },
              )
            ],
          );
              ...
              MaterialButton(
                ...
                onPressed: () async {
                  ...
                  for (var i = 0; i < cname.length; i++) {
                    await placeorder(cname[i], ccat[i], cimage[i], cprice[i],
                        cquantity[i], cid[i], cseller[i]);
                  }
                  pr.hide();
                },
              )
              ...
              child: new Column(
                children: <Widget>[
                  new Row(
                    ...
                    children: <Widget>[
                      Center(
                        child: Text(cname[0].toString() + " & more"),
                      )
  ...
  createAlertDialog1(BuildContext context, String n, String c, String p,
      String pr, String q, String i, String s) {
    TextEditingController customController = TextEditingController();
    return showDialog(
        context: context,
        builder: (context) {
  ...
  createAlertDialog2(BuildContext context, String name, String cat, String pic,
      String price, String quantity, String id, String seller) {
              ...
              actions: <Widget>[
                MaterialButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pop();
                    createAlertDialog1(
                        context, name, cat, pic, price, quantity, id, seller);
                  },
                )
              ],
            ),
                  ...
                  return new Card(
                    child: SingleChildScrollView(
                      child: ListTile(
                        leading: InkWell(
                            onTap: () {},
                            child: new Image.network(cimage[index],
...
placeorder(String name, String cat, String image, String price, String quantity,
    String id, String seller) async {
  ...
  Products prod = new Products(
      id, cat, loc, double.parse(price), double.parse(quantity), seller);
